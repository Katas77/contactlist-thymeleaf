# Приложение для управления контактами с бэкендом на Spring Boot и фронтендом. Фронтенд, после запуска приложения, доступен по адресу: [http://localhost:8080/](http://localhost:8080/)
